...
<Text style={{color:'white', textAlign:'center', fontWeight:'600', fontSize:15}}>20%</Text>
    ...
    <FontAwesome name="share" size={24} color="black" />
      ...
      <AntDesign name="hearto" size={24} color="black" />
        ...
        <Text style={{height:1, borderWidth:1, borderColor:'#D0D0D0'}}/>
        <View style={{padding:10}}>
  <Text style={{marginVertical:5, fontSize:15, fontWeight:'bold'}}>Total: ₹ {route.params?.price}</Text>
  <Text style={{color:'#00CED1'}}>Free Delivery Tomorrow by 3 PM. Order withnin 10hrs 25mins</Text>
        </View>
        <View style={{flexDirection:'row', marginVertical:5, gap:5, alignItems:'center'}}>
        <Entypo name="location-pin" size={24} color="black" />
        <Text style={{fontSize:15, fontWeight:'bold'}}>Deliever to Lakhan - Pune 114014</Text>
        </View>
        <Text style={{color:'green', marginHorizontal:10, fontWeight:'500'}}>In Stock</Text>
        <Pressable onPress={()=>handleAddToCart(route?.params.item)} style={{backgroundColor:'#FFC72C', padding:10, borderRadius:20, alignItems:'center', justifyContent:'center', marginHorizontal:10, marginVertical:10}}>
